...
$sql = "SELECT tblbooking.BookingId as bookid,tblbooking.PackageId as pkgid,tblvehicles.PackageName as packagename,tblbooking.FromDate as fromdate,tblbooking.ToDate as todate,tblbooking.Comment as comment,tblbooking.status as status,tblbooking.RegDate as regdate,tblbooking.CancelledBy as cancelby,tblbooking.UpdationDate as upddate from tblbooking join tblvehicles on tblvehicles.PackageId=tblbooking.PackageId where UserEmail=:uemail";
          ...
          <?php if($result->status==2)
          {
          	?><td>Cancelled</td>
          <?php } else {?>
          <td><a href="vehicle-history.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to cancel booking')" >Cancel</a></td>
          <?php }?>
          </tr>
          <?php $cnt=$cnt+1; }} ?>
          	</table>
