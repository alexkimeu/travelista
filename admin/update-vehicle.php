...
$sql="update tblvehicles set PackageName=:pname,PackageType=:ptype,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails where PackageId=:pid";
...
<html>
<head>
<title>TMS | Admin Vehicle Creation</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Update Vehicle </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<?php
$pid=intval($_GET['pid']);
$sql = "SELECT * from tblvehicles where PackageId=:pid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':pid', $pid, PDO::PARAM_STR);
$query->execute();
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Vehicle Price in USD</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Vehicle Features</label>
									<div class="col-sm-8">
