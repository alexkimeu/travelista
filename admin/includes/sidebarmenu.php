                           ...
                           <div class="menu">
									<ul id="menu" >
									 ...
									 <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Hotels</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										...
										<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Vehicles</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
 										   <ul id="menu-academico-sub" >
 										   <li id="menu-academico-avaliacoes" ><a href="create-vehicle.php">Create</a></li>
 											<li id="menu-academico-avaliacoes" ><a href="manage-vehicle.php">Manage</a></li>
 										  </ul>
 										</li>

									<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Tours</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
 										   <ul id="menu-academico-sub" >
