    ...
    <body>
      ...
      <section class="sample-text-area">
        <div class="container">
          <div class="privacy">
          	<div class="container">
          		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Hotel Bookings</h3>
          ...
          $sql = "SELECT tblbooking.BookingId as bookid,tblbooking.PackageId as pkgid,tblhotels.PackageName as packagename,tblbooking.FromDate as fromdate,tblbooking.ToDate as todate,tblbooking.Comment as comment,tblbooking.status as status,tblbooking.RegDate as regdate,tblbooking.CancelledBy as cancelby,tblbooking.UpdationDate as upddate from tblbooking join tblhotels on tblhotels.PackageId=tblbooking.PackageId where UserEmail=:uemail";
